...
\makeatletter
\newcommand{\theauthor}{AUTHOR NAME} %FILLIN
\makeatother
...
{Bachelor/Master Thesis} %FILLIN
\vspace{80pt}%
%------------------------------------------
\makeTitleThesis%
%[An approach using DuMuX] %
{...} %FILLIN
\vspace{90pt}%
%------------------------------------------
...
\addAuthorInfo{Author}{...} %FILLIN
\addAuthorInfo{Student ID}{...} %FILLIN
...
\bibliography{common/literatur.bib}
