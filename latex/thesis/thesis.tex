...
is indistinguishable from the Störmer-Verlet solution. The CNN solution gets unstable after
a few time iterations.

Additionally, the FD basis gives interpretability in terms of finite differences in our context.
...
The training and test losses for the LARGE-CNN and CG-SympNets
