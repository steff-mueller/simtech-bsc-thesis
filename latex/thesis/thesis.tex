...
One choice is the canonical basis with basis vectors $b_1, \dots, b_{m+1} \in \mathbb{R}^{2m+1}$ given by
\begin{equation*}
...
\begin{align*}
	...
	.
\end{align*}
So $\{ b_i^{FD} \}_{i=1}^{m+1}$ is a valid basis of
...
The FD basis gives interpretability in terms of finite differences,
which makes it a favorable choice in our context.
