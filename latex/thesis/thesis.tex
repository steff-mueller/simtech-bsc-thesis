...
semi-discretization in space of Hamiltonian PDEs. In particular, we successfully 
...
fruitful and enjoyable - due to the COVID-19 pandemic - online discussions.
\clearpage
\newpage\thispagestyle{plain}\null
\newpage\thispagestyle{plain}
...
\cite{leimkuhler_reich_2005}. This property of the flow map led to the development of 
...
In this thesis, we extend the SympNets proposed by \citeauthor{Jin2020} by introducing
...
We believe that the idea to intrinsically embed a priori information of a system
