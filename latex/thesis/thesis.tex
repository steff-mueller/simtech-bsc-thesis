...
\begin{tikzpicture}
	...
	\addplot[
		color=brown
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/fnn/loss.csv};

	\addplot[
		color=red
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/la-sympnet/loss.csv};

	\addplot[
		color=red, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n1-la-sympnet/loss.csv};

	\addplot[
		color=red, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n2-la-sympnet/loss.csv};

	\addplot[
		color=blue
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/g-sympnet/loss.csv};

	\addplot[
		color=blue, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n1-g-sympnet/loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n2-g-sympnet/loss.csv};
...
\begin{tikzpicture}
	...
	\addplot[
		color=brown
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/fnn/test_loss.csv};

	\addplot[
		color=red
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/la-sympnet/test_loss.csv};

	\addplot[
		color=red, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n1-la-sympnet/test_loss.csv};

	\addplot[
		color=red, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n2-la-sympnet/test_loss.csv};

	\addplot[
		color=blue
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/g-sympnet/test_loss.csv};

	\addplot[
		color=blue, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n1-g-sympnet/test_loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/n2-g-sympnet/test_loss.csv};
...
\begin{tikzpicture}
	...
	\addplot[
		color=blue
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_rot/g-sympnet/loss.csv};

	\addplot[
		color=blue,dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_rot/n1-g-sympnet/loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_rot/n2-g-sympnet/loss.csv};+
...
\begin{tikzpicture}
	...
	\addplot[
		...
		dashed,
		select coords between index={0}{72}
	] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing_rot/n1-g-sympnet/swinging_case/phase_plot.csv};
...
\begin{tikzpicture}
	...
	\addplot[
		...
		densely dotted,
		no markers
	] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing_rot/n1-la-sympnet/rotating_case/phase_plot.csv};
	...
	\addplot[
		...
		densely dotted,
		no markers
	] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing_rot/n1-g-sympnet/rotating_case/phase_plot.csv};
...
\begin{tikzpicture}
	...
	\addplot[
		color=blue, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing_rot/n1-g-sympnet/loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing_rot/n2-g-sympnet/loss.csv};
