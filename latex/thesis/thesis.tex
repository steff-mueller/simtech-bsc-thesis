...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\nextgroupplot[
			...
			\addplot[
				color=red,densely dotted
			] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing/n2-la-sympnet/sigmoid/swinging_case/phase_plot.csv};
	
			\addplot[
				color=blue,densely dotted, opacity=0.5
			] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing/n2-g-sympnet/tanh/swinging_case/phase_plot.csv};
		...
		\nextgroupplot[title={Phase plot for $q_0 = \pi,\, p_0=1$}]
			...
			\addplot[
				color=blue,densely dotted
			] table[x=q,y=p,col sep=comma] {../data/simple_pendulum_swing/n2-g-sympnet/tanh/rotating_case/phase_plot.csv};
	
		\end{groupplot}
	\end{tikzpicture}
	\\[5pt]
	\ref{leg_ped_swing_phase}
	\caption{Phase plots for simple pendulum. Training data uniformly sampled from swinging domain.}
\end{figure}
...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\addplot[
			color=violet
		] table[x=t,y=E,col sep=comma] {../data/simple_pendulum_swing/n2-la-sympnet/sigmoid/swinging_case/total_energy.csv};

		\addplot[
			color=blue,densely dotted
		] table[x=t,y=E,col sep=comma] {../data/simple_pendulum_swing/n2-g-sympnet/tanh/swinging_case/total_energy.csv};
			
		\end{axis}
	\end{tikzpicture}
	\caption{Total energy over time for $q_0 = \frac{\pi}{2},\, p_0 = 0$}
\end{figure}
