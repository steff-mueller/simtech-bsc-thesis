...
i.e. $\theta = (vec(W), b)^T \in \R^{n_2 n_1 + n_2}$.
...
\begin{tikzpicture}
	...
	\addplot[
		color=red, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/normalized-la-sympnet-ignore-factor/loss.csv};

	\addplot[
		color=red, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/normalized-la-sympnet/loss.csv};
	...
	\addplot[
		color=blue, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/normalized-g-sympnet-ignore-factor/loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing/normalized-g-sympnet/loss.csv};+
...
\begin{tikzpicture}
	...
	\addplot[
		color=blue,dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_rot/normalized-g-sympnet-ignore-factor/loss.csv};

	\addplot[
		color=blue, densely dotted
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_rot/normalized-g-sympnet/loss.csv};+
...
\begin{tikzpicture}
	...
	\addplot[
		color=blue, dashed
	] table[x=epoch,y=loss,col sep=comma] {../data/simple_pendulum_swing_rot/normalized-g-sympnet-ignore-factor/loss.csv};
