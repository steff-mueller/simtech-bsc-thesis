...
\begin{frame}[c]{Convolution Gradient layers}
  ...
  \begin{itemize}
    \item TODO
    \item \todo{transposed cross-correlation}
  \end{itemize}
\end{frame}
...
\begin{frame}{Training and test data, loss}
  \todo{Activation function}
\end{frame}
...
\begin{frame}[c]
  \begin{figure}
    ...
    \caption{\bemph{LA-SympNet architecture.}}
  \end{figure}
\end{frame}
...
\begin{frame}[c]
  \begin{figure}
    ...
    \caption{
      ...
      Convolution Gradient layers with kernel size $100$ and stride $100$.
    }
  \end{figure}
\end{frame}