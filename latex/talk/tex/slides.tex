...
\begin{frame}{Symmetric kernel}
  \todo{Parametrization, canonical and FD basis}
\end{frame}

\begin{frame}[c]{Convolution Gradient layers}
  The (symplectic) \bemph{gradient convolution layers} are given by the layer transform
  \begin{equation*}
...
\begin{frame}[c]{Simple pendulum}
  ...
  \begin{tikzpicture}[node distance=0.3cm]
    ...
    \node (a1) [draw,text width=5cm,align=center,rotate=90,right=of c4.south east,anchor=north east,
      ...
      {Lower Activation layer\\ $\layertf(p) = \lb a_i \activation(p_i) \rb_{i=1}^d$};
...
\begin{frame}[c]{Sine-Gordon}
  \centering
  \begin{tikzpicture}
    \node [draw,text width=6cm,align=center] at (0,0) 
      {Lower Convolution layer\\ $T(p) = \star_{\text{v}}(k,\chi_{\text{pad},m}(p))$};

    \node [draw,text width=6cm,align=center] at (0,-1.5) 
      {Lower Gradient Convolution layer\\ $T(p) = ...$};

    \node [draw,text width=6cm,align=center] at (0,-3) 
      {Upper Convolution layer\\ $T(p) = \star_{\text{v}}(k,\chi_{\text{pad},m}(p))$};

    \node [draw,text width=6cm,align=center] at (0,-4.5) 
      {Upper Gradient Convolution layer\\ $T(p) = ...$};

      \node [draw,text width=6cm,align=center] at (8,0) 
      {Lower Convolution layer\\ $T(p) = \star_{\text{v}}(k,\chi_{\text{pad},m}(p))$};

    \node [draw,text width=6cm,align=center] at (8,-1.5) 
      {Lower Gradient Convolution layer\\ $T(p) = ...$};

    \node [draw,text width=6cm,align=center] at (8,-3) 
      {Upper Convolution layer\\ $T(p) = \star_{\text{v}}(k,\chi_{\text{pad},m}(p))$};

    \node [draw,text width=6cm,align=center] at (8,-4.5) 
      {Upper Gradient Convolution layer\\ $T(p) = ...$};
  \end{tikzpicture}
\end{frame}