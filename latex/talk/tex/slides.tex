\begin{frame}[c]{Motivation}
  \begin{center}
    ...
    \vspace{0.3cm}
    \bemph{Idea:} Use symplectic neural networks as
    proposed by \citeauthor{Jin2020}\footcite{Jin2020}
  \end{center}
...
\begin{frame}[c]{Normalized Activation layers}
  The (symplectic) \bemph{normalized activation layers} are defined by the layer transform
  \begin{equation*}
...
\begin{frame}[c]{Normalized Gradient layers}
  The (symplectic) \bemph{normalized gradient layers} are defined by the layer transform
  \begin{equation*}
